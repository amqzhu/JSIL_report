...
\newcommand{\polish}[2]{{\color{red}#1}~{\color{blue}[#2]}}
...
I would also like to thank Jos\'e Fragoso Santos for setting up my programming environment and explaining logical concepts. In addition, I would like to thank Thomas Wood for creating and maintaining the testing framework. 
...
\subsection{JSIL}\label{sec:jsil}
\pmax{High-level, just like others, so that we have a reference later}
...
Extensive changes have occurred in the 5\textsuperscript{th} edition of the ECMAScript standard, including the addition of a strict mode and accessor properties\cite{EcmaScript} , both of which will be addressed in this project. \polish{Strict mode - better behavioural properties, etc.}{brief} \polish{Accessors - what do they do?}{brief} This chapter serves as an in-depth introduction to the internal workings of JavaScript as a programming language.
