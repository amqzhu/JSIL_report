...
Extensive changes have occurred in the 5\textsuperscript{th} edition of the ECMAScript standard, including the addition of a strict mode and accessor properties\cite{EcmaScript} , both of which will be addressed in this project.
...
\begin{tikzpicture}
  ...
  \node[sbox,sz={\d}{\w},rectangle split,rectangle split parts=6, fill=black!35] (global) 
    {     
      ...
      \nodepart{three}{\scriptsize Number: \(l_{\mathsf{num}}\)}
      \nodepart{four}{\scriptsize $\mathtt{w : undefined}$}
      \nodepart{five}{\scriptsize $\mathtt{z : undefined}$}
  ...
  \node[sbox,sz={\d}{\w},below right= -0.3cm and 0.75cm of global,rectangle split,rectangle split parts=2,fill=black!25] (number) 
    {\hspace*{0.75cm}\(\vdots\)%
      \nodepart{second}{\scriptsize prototype: \(l_{\mathsf{np}}\)}};
    \node[above left=0cm and 0cm of number,ll] {Number: \(l_{\mathsf{num}}\)};
  %%%%%%%% end of number 
  %%%%%%%% number op node
  \node[sbox,sz={\d}{\w},right= 0.75cm of obj, rectangle split,rectangle split parts=3,fill=black!10] (op) 
    {\hspace*{0.75cm}\(\vdots\)%
        \nodepart{second}{\scriptsize $\mathtt{y : "banana"}$}
      \nodepart{third}{\scriptsize@proto: null}};
  ...
  \node[above left=0cm and 0.2cm of np,ll] {Number.prototype: \(l_{\mathsf{np}}\)};
  %%%%%%%% end of op 
  %%%%%%%% dots
  ...
  %%%%%%%% end connection
\end{tikzpicture}
\caption{ES5 Strict initial heap + first two commands of example}
\label{fig:initheap}
\end{center}
\end{figure}
