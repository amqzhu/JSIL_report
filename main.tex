...
%Separation logic has been used to reason about JavaScript programs, modelling program execution based on a heap structure. 
...
\smallskip
The completion of this project marked the end of implementing the core language constructs as well as the most critical built-in libraries of JavaScript in JSIL. The only portions of the JSIL reference implementation that remain to be completed is the Function constructor. %and parts of the String library.
